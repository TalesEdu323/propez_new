-- ==============================================================================
-- Propez — Script SQL completo para Neon/Postgres (copiar e colar)
-- ==============================================================================
-- Este é o conteúdo aplicado automaticamente pelo servidor no boot
-- (runStartupMigrations). Colar manualmente só é necessário se quiseres
-- preparar o banco antes do primeiro deploy.
--
-- Ordem:
--   1. 002_core.sql            — tenants, users, auth, entidades de negócio
--   2. 001_integrations.sql    — tabelas das integrações ProSync/Rubrica
--   3. 003_integrations_org.sql — vínculo org <-> integrações
--
-- 100% idempotente: pode rodar múltiplas vezes sem efeitos colaterais.
-- ==============================================================================
