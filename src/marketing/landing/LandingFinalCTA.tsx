...
import { LANDING_FINAL_CTA } from '../siteCopy';
  ...
  return (
    <section className="py-24 bg-white border-t border-gray-100">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <AnimatedSection>
          <h2 className="text-3xl md:text-5xl font-bold mb-8 font-heading text-balance">
            {LANDING_FINAL_CTA.heading}
          </h2>
          <p className="text-xl md:text-2xl text-gray-500 font-medium leading-relaxed mb-12 text-balance">
