...
export function createNotificationsRouter(): Router {
  ...
  router.get('/notifications', async (_req: Request, res: Response) => {
    try {
      const notifications = [
        { id: 1, title: 'Bem-vindo ao Propez!', message: 'Obrigado por escolher nossa plataforma para transformar suas propostas em experiências memoráveis.', date: new Date().toISOString() },
